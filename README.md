# Mortage Sliders (Material UI + React)
    Demo followed: https://www.freecodecamp.org/news/react-mortgage-calculator-tutorial-for-beginners/

## Random Notes
* The useState hook is a built-in React function that allows you to add state to functional components. It returns an array containing two elements: the current state value and a function to update that value.
